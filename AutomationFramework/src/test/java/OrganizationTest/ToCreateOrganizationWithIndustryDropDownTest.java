...
public class ToCreateOrganizationWithIndustryDropDownTest extends BassClass {
	@Test(groups = "regression")
	public void ToCreateOrgWithIndustryDropDown() throws EncryptedDocumentException, IOException {
		...
		industrydropdown.contains(DROPDOWN));
